...
function trackView(a){a=a.replace("https://","").replace("http://","").replace("mailto:",""),ga("send","pageview","/"+a)}function trackEvent(a,t,e){ga("send","event",a,t,e)}$('[data-event="ga"]').on("click",function(){var a=$(this).data("category")?$(this).data("category"):"",t=$(this).data("action")?$(this).data("action"):"",e=$(this).data("label")?$(this).data("label"):"";trackEvent(a,t,e)}),$("body").on("click",'a[target="_blank"], [data-ga]',function(){var a,t=$(this),e=t.attr("href"),n=t.data("ga");n?(a=n,a.indexOf("/")<0&&(a=a+"/"+e)):t.attr("target")&&(a="external/"+e),trackView(a)});
$(function(){$(".js-header").headroom({offset:30,tolerance:5,classes:{initial:"is--top",pinned:"is--pinned",unpinned:"is--unpinned",top:"is--top"}})});
$(function(){var e=$(".js-waypointitem");e.each(function(){new Waypoint.Inview({element:this,enter:function(e){$(this.element).addClass("is-animated")},entered:function(e){$(this.element).addClass("is-animated")},offset:"bottom-in-view"})})});
